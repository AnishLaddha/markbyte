/* This is a 404 page displayed when the user tries to access a page that does not exist. */
...
function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#011A29] p-6 text-center overflow-hidden relative">
